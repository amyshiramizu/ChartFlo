...
import { FileText, Users, ClipboardList, Settings, Mic, Send, Menu, X, LogOut, HeartPulse, Activity, CalendarDays, Stethoscope, BookOpen, DollarSign, BarChart3, ClipboardCheck } from 'lucide-react';
